...
public class AutoClicker extends Module {
	...
	public AutoClicker() {
		...
		Hanukkah.instance.settingsManager.rSetting(new Setting("MinCPS", this, 8, 1, 20, false));
		Hanukkah.instance.settingsManager.rSetting(new Setting("MaxCPS", this, 12, 1, 20, false));
		Hanukkah.instance.settingsManager.rSetting(new Setting("Mouse Hold", this, false));
	}
	...
	private void updateVals() {
		min = Hanukkah.instance.settingsManager.getSettingByName(this, "MinCPS").getValDouble();
		max = Hanukkah.instance.settingsManager.getSettingByName(this, "MaxCPS").getValDouble();
		wait = Hanukkah.instance.settingsManager.getSettingByName(this, "Mouse Hold").getValBoolean();
		if (min >= max) {
			max = min + 1;
		}
		if(nullCheck()) return;
