package me.posotrite.hanukkahhack.clickgui.component.components;
...
import me.posotrite.hanukkahhack.clickgui.component.Component;
import me.posotrite.hanukkahhack.clickgui.component.Frame;
import me.posotrite.hanukkahhack.clickgui.component.components.sub.Checkbox;
import me.posotrite.hanukkahhack.clickgui.component.components.sub.Keybind;
import me.posotrite.hanukkahhack.clickgui.component.components.sub.ModeButton;
import me.posotrite.hanukkahhack.clickgui.component.components.sub.Slider;
import me.posotrite.hanukkahhack.clickgui.component.components.sub.VisibleButton;
...
public class Button extends Component {
	...
	public Button(Module mod, Frame parent, int offset) {
		...
		height = 12;
		int opY = offset + 12;
		if(Hanukkah.instance.settingsManager.getSettingsByMod(mod) != null) {
			for(Setting s : Hanukkah.instance.settingsManager.getSettingsByMod(mod)){
				if(s.isCombo()){
